---
summary: "Native Windows companion app, native CLI and Gateway, and WSL2 install paths"
read_when:
  - Installing OpenClaw natively on Windows
  - Choosing between native Windows and WSL2
  - Looking for the native Windows companion app status
...
When the app is launched from a built source checkout, it looks for
